...
def send_email(to: str, subject: str, body_html: str, body_text: str = None) -> bool:
    ...
    thread = threading.Thread(target=_send_email_async, args=(to, subject, body_html, body_text))
    thread.start()
    return True
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #1a1a2e; border-radius: 8px; padding: 24px; margin: 24px 0;">
        <tr>
            <td>
                ...
                {"<p style='margin: 20px 0 12px; font-size: 14px; color: #71717a;'>YOUR NOTES</p><p style='margin: 0; font-size: 16px; color: #a1a1aa;'>" + notes + "</p>" if notes else ""}
            </td>
        </tr>
    </table>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #1a1a2e; border-radius: 8px; padding: 24px; margin: 24px 0;">
        <tr>
            <td>
                ...
                {f"<p style='margin: 0 0 20px; font-size: 14px; color: #a1a1aa;'>📞 {client_phone}</p>" if client_phone else ""}
                ...
                {"<p style='margin: 20px 0 12px; font-size: 14px; color: #71717a;'>CLIENT NOTES</p><p style='margin: 0; font-size: 16px; color: #a1a1aa;'>" + notes + "</p>" if notes else ""}
            </td>
        </tr>
    </table>
